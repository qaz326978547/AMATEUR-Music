...
class SearchPage extends Component {
  ...
  componentDidMount = async () => {
    ...
    let checkList = await Axios.get(`http://localhost:9000/${(document.cookie == "") ? "search/情歌" : `checkLike/${document.cookie}/user/情歌`}`);
  ...
  test = () => {
    console.log(this.state.checkLikeList)
    // console.log(document.querySelectorAll('.heartDiv')[0].attributes.idx.value)
  }
